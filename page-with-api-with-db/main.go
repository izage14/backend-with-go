...
func main() {
    ...
    var err error
    conn, err = pgx.Connect(ctx, "postgresql://neondb_owner:npg_4LIbQX6PayUK@ep-dawn-pine-adu0ytt4-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require")
    if err != nil {
